 <div class="content-wrapper">
    ...
    <a  href="<?php echo base_url('Truststaff/get_all_fees_view');?>" class="btn btn-warning pull-left" style="margin-left:1em;">Previous</a>  
       <div class="row">
	 
 <?php $attributes = array("name" => "add section");
        echo form_open("Truststaff/generate_all_fees_payment_pdf", $attributes);?>
