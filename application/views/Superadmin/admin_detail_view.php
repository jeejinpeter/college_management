          ...
          foreach($list->result() as $val):?>
           ...
           <li>
            <a href=""  class="admin_id" data-toggle="modal" data-id="<?php echo $val->login_id;?>"data-target="#myModal-<?=$val->login_id?>"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
                    ...
                    <li><a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('Superadmin/remove_admin/'.$val->login_id);?>"><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</a></li>
                  </ul>
                </div></td>
                          </tr>
  <!-- Modal edit class-->
 ...
 <div class="container">
  <div class="x_content">
     ...
     <?php $attributes = array("name" => "AddAdmin");
                echo form_open("User/admin_add_process", $attributes);?>
                  <div class="box-body">
