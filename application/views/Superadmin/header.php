                    ...
                    <ul class="nav navbar-top-links navbar-right" style="float:right; padding-right:3%;">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><h4><center>Admin</center></h4></li>
                                
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url('Superadmin/change_superadmin_password');?>"><i class="fa fa-gear fa-fw"></i> Change Password</a>
                                </li>
                                <li class="divider"></li>
                                <li>
                            ...
                            <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="myNavbar">
                                    <ul class="nav navbar-nav">
                                        <li>   <a  href="<?php echo base_url('Superadmin/home_page');?>">Home</a>
 </li>
    <li><a href="<?php echo base_url('Superadmin/link_add_admin');?>">Add New Admin</a>
        ...
        <ul class="dropdown-menu">
                                                ...
                                                <li>    <a href="<?php echo base_url('/index.php/Superadmin/Add_fund_view');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>Add Funds</b></a> </li>
                                                 <li>    <a href="<?php echo base_url('/index.php/Superadmin/list_college_fund');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>View Funds</b></a> </li>
                                                 </ul>
                                         </li>                                  
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                                    <li>
                        <a href="<?php echo base_url('Superadmin/display_all_staff_list');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>All</b></a> 
                    </li>
                                                <li>    <a href="<?php echo base_url('Superadmin/display_teaching_list');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b> Teaching </b></a> </li>
                                                  <li>
                        <a href="<?php echo base_url('Superadmin/display_non_teaching_list');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b> Non-Teaching</b></a> 
                    </li>
                                            </ul>
                                        </li>
                  <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>    <a href="<?php echo base_url('Superadmin/list_Admission');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>View Admitted Students</b></a> </li>
                                                 <li>    <a href="<?php echo base_url('Superadmin/list_all_Admission');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>View All Students</b></a> </li>
                                                 </ul>
                                         </li> 
                                          <li class="dropdown">
                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Fees Collection Details<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                     <li><a href="<?php echo base_url('Superadmin/get_fees_view');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>Student Fee Remittance</b></a> </li>
                      <li><a href="<?php echo base_url('Superadmin/get_all_fees_view');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>Pending Fees View</b></a></li>                            
                                            </ul>
                                        </li> 
                                           <li>
                                            <a href="<?php echo base_url('Superadmin/get_college_expenses');?>">Expense Details</a>
                                            
                                        </li>
                                        <li class="dropdown">
                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Messages<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                     <li><a href="<?php echo base_url('Superadmin/link_send_message');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>New Message</b></a> </li>
                        <li>
                                            <a href="<?php echo base_url('Superadmin/get_sent_messages');?>"><i class="fa fa-gear fa-1x" aria-hidden="true"></i><b>Sent Messages</b></a>
...
$(document).ready(function () {
    ...
    $(".tab a").on("click", function () {
        ...
        $(this).parent().addClass("active");
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-header" style="border-bottom: 2px solid #ffc107;">Welcome <b>Admin</b>, to the Panel of SNGCAS-Chelannur</h3>
