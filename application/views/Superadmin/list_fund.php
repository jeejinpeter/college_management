...
<div class="container">
         ...
         {   
			  ...
			  ?>
				...
				<td><a href="<?php echo site_url('Superadmin/edit_funds/'.$row->f_id); ?>" class="glyphicon glyphicon-pencil red "></a>&nbsp; &nbsp;
	<a class="glyphicon glyphicon-trash green"  data-toggle="modal" data-target="#delete-<?=$row->f_id?>" href="#"></a></td>
	 ...
	 <div class="modal fade" id="delete-<?=$row->f_id;?>" role="dialog" >
      <div class="modal-dialog">
       ...
       <form name="billing" method="post"  enctype="multipart/form-data" action="<?php echo base_url().'Superadmin/Delete_fund' ?>" >
