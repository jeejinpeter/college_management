  ...
  <div class="content-wrapper">
	...
	<h3 class="box-title">Add Achievements</h3>
			...
			<?php $attributes = array("name" => "news");
                echo form_open_multipart("Admin/add_achievement_processing", $attributes);?>
              ...
              <h4><?php echo $this->session->flashdata('msg'); ?></h4><br>
                <!-- text input -->
				 ...
				 <div class="form-group">
                  <label>Title</label>
               <input type="text" class="form-control" placeholder="Achievement Title" name="achi_title"  value="<?php echo set_value('achi_title'); ?>">
				 <span class="text-danger"><?php echo form_error('achi_title'); ?></span>
                </div>
    ...
    <span class="text-danger"> <?php echo form_error('achi_image'); ?></span>
